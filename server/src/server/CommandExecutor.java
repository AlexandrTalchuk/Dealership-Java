...
public class CommandExecutor {
    ...
    public static Object split(String command) {
        ...
        switch (commandNumber[0]) {
            ...
            case "removeloan":
                commands = command.split(" ", 2);
                result = DB.removeLoan(Integer.parseInt(commands[1]));
                break;
            case "removeSellCars":
                commands = command.split(" ", 2);
                result = DB.removeSellCars(Integer.parseInt(commands[1]));
                break;
            case "addmanager":
            ...
            case "addsellcars":
                ...
                result = DB.addsellCar(commands[1], commands[2], commands[3], commands[4], commands[5]);
                break;
            case "markaccepted":
                commands = command.split(" ", 2);
