...
public class DB {
    ...
    public static ArrayList<String> getLoan() {
        ResultSet resultSet;
        ArrayList<String> list = new ArrayList<>(0);
        String select = "SELECT * FROM dealership.loan";
        try {
            PreparedStatement preparedStatement = connection.prepareStatement(select);
            resultSet = preparedStatement.executeQuery();
            while (resultSet.next()) {
                ...
                order.append(resultSet.getInt("number")).append(" ").
                        ...
                        append(resultSet.getString("numberOfYears")).append(" ").
                        append(resultSet.getString("percentages")).append(" ").
                        append(resultSet.getString("model"));
                list.add(order.toString());
            }
        } catch (SQLException e) {
    ...
    public static boolean AddALoan(String order) {
        String[] orderDetails = order.split(" ", 15);
        System.out.println(order);
        String insert = "INSERT INTO dealership.loan (make, year, name, surname, price, color,country, insurance, model,amount,numberOfYears,percentages)" +
                "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?)";
        try {
           ...
           preparedStatement.setString(8, orderDetails[8] + " " +
            ...
            preparedStatement.setString(10, orderDetails[12]);
            preparedStatement.setString(11, orderDetails[13]);
            preparedStatement.setString(12, orderDetails[14]);
            preparedStatement.executeUpdate();
        } catch (SQLException e) {
            e.printStackTrace();
            return false;
    ...
    public static boolean removeLoan(int NumberColumn) {

        String delete = "DELETE FROM dealership.loan WHERE number=?";

        try {
            PreparedStatement preparedStatement = connection.prepareStatement(delete);
            preparedStatement.setInt(1, NumberColumn);
            preparedStatement.executeUpdate();
        } catch (SQLException e) {
            return false;
        }
    ...
    public static boolean removeSellCars(int NumberColum) {

        String delete = "DELETE FROM dealership.sellcars WHERE number =?";

        try {
            PreparedStatement preparedStatement = connection.prepareStatement(delete);
            preparedStatement.setInt(1, NumberColum);
            preparedStatement.executeUpdate();
        } catch (SQLException e) {
            return false;
        }
    ...
    public static ArrayList<String> getsellCar() {
        ResultSet resultSet;
        ArrayList<String> list = new ArrayList<>(0);
        String select = "SELECT * FROM dealership.sellcars";
        try {
            PreparedStatement preparedStatement = connection.prepareStatement(select);
            resultSet = preparedStatement.executeQuery();
            while (resultSet.next()) {
                ...
                order.append(resultSet.getInt("number")).append(" ").
                        ...
                        append(resultSet.getString("year")).append(" ").
                        append(resultSet.getString("price")).append(" ").
                        append(resultSet.getString("TypeOfBody")).append(" ");
                list.add(order.toString());
            }
        } catch (SQLException e) {
            e.printStackTrace();
    ...
    public static boolean addsellCar(String make, String model,String year,String price, String TypeOfBody) {
        String insert = "INSERT INTO dealership.sellcars (make,model, year,price,TypeOfBody) VALUES (?,?,?,?,?)";
        ...
        try {
            ...
            preparedStatement.setString(5, TypeOfBody);
            preparedStatement.executeUpdate();
        } catch (SQLException e) {
            return false;
        }
